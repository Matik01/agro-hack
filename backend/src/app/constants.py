...
class AppConstants:
    SYSTEM_PROMPT: str = """
            ...
            - Если указано только название подразделения (например, "АО Кропоткинское") в начале сообщения — применяй его ко всем операциям в этом сообщении.
            - Если в сообщении встречаются конструкции вида "ПУ Юг X/Y", "По ПУ Юг X/Y", "2025 г ПУ Юг X/Y" и им подобные, то:
                - Игнорируй слово "Юг" и другие дополнительные слова.
                - Извлекай числовые значения X и Y как "площадь_по_ПУ":
                    - X — значение "за_день"
                    - Y — значение "c_начала_операции"
                - Заполняй эти значения в соответствующее поле "площадь_по_ПУ" текущей операции.
                - Обрабатывай фразы с "ПоПУ", "ПУ", "По ПУ", "ПУ Юг", "2025 г ПУ Юг" и другие варианты одинаково — все они указывают на "площадь_по_ПУ"
            """
    FEW_SHOT_EXAMPLES: list = field(default_factory=lambda: [
        {
            "input": "Внесение почвенного гербицида по подсолнечнику \n  день 82га \n  от начала 82га (38%)",
            "output": {
                "дата": None,
                "операции": [
                    {
                        ...
                        "площадь": {
                            "за_день": 82,
                            "c_начала_операции": 82
                        },
                        "площадь_по_ПУ": {
                            "за_день": None,
                            "c_начала_операции": None
                        },
                        "растительная_культура": "Подсолнечник товарный",
                        "вал": {
                            "за_день": None,
                            "с_начала": None
                        }
